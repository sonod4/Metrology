...
r = model.fastSampleAnalysis(Nstates=Nstates,Npars=Npars,parametersRange=np.array([[0,2*pi],[0,2*pi],[0,2*pi]]),metrics=metrics,
							save=f"data/su2_3pars_{dim}bit_{suppression[0]},{suppression[1]}suppress_{Nstates}_{Npars}.pkl")
